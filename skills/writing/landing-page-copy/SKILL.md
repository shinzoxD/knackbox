...
description: >-
  Write and improve landing-page copy with a clear offer, credible proof,
...
Write for a specific audience making a specific decision. Clarity about the
offer and next action comes before cleverness.
...
- For a new product without proof, use transparent product specifics, founder
  credibility, demonstrations, or a low-commitment CTA.
- For multiple audiences, choose a primary audience or create distinct paths;
  do not make the hero carry every use case.
- For regulated products, keep claims inside approved language and surface
  required qualifications near the claim.
