...
description: >-
  Turn a rough initiative into a decision-ready project proposal with outcomes,
...
Write a proposal that helps a specific decision-maker decide whether to approve,
fund, or prioritize the work.
...
- For an early idea, produce a one-page concept proposal and list the evidence
  required before a larger commitment.
- For a rejected proposal, preserve the decision rationale and define conditions
